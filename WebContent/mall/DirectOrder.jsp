...
<div class="container">
    <h2>주문하기</h2>
    <form action="insertDirectOrder.do" method="post" id="form">
        <div class="product">
...
<%--                            <input type="text" name="cartid" value="${cart.cartid}" hidden="hidden">--%>
                            <input type="text" name="pno" value="${param.pno}" hidden="hidden">
                            <td><input type="text" name="pimage" hidden="hidden" value="${param.pimage}"><img
                                    src="/spring/upload/${param.pimage}" alt="no image" width="50px" height="50px"
                                    name="pimage"></td>
                            <td><input type="text" name="pname" value="${param.pname}"></td>
                            <td><input type="text" name="optionname" value="${param.optionname}"></td>
                            <td><input type="text" name="cartcount" value="${param.count}"></td>
                            <td><input type="text" name="remain" value="${param.remain}"></td>
            ...
            <div class="paymentDiv" id="cardPayment">
                <table>
                    <tr>
                        ...
                        <td>
                            <!--                            카드번호 4자리씩 4개-->
                            <input type="text" name="cardnum1" value="" maxlength="4" size="4" >-
                            <input type="text" name="cardnum2" value="" maxlength="4" size="4" >-
                            <input type="text" name="cardnum3" value="" maxlength="4" size="4" >-
                            <input type="text" name="cardnum4" value="" maxlength="4" size="4" >
                        </td>
                    </tr>
                </table>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var count=0;
            ...
            var totalPriceInput = $('input[name^="totalPrice"]');
