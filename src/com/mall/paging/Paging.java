...
public class Paging {
	...
	public Paging(int currentPage, int totalCount, int blockCount, int blockPage, String pageUrl) {
		this(null, null, currentPage, totalCount, blockCount, blockPage, pageUrl, null);
	}

	public Paging(int currentPage, int totalCount, int blockCount, int blockPage, String pageUrl, String addKey) {
		this(null, null, currentPage, totalCount, blockCount, blockPage, pageUrl, addKey);
	}

	public Paging(String keyField, String keyWord, int currentPage, int totalCount, int blockCount, int blockPage,
				  String pageUrl) {
	...
	public Paging(String keyField, String keyWord, int currentPage, int totalCount, int blockCount, int blockPage,
		...
		if (currentPage > 1) {
			if (keyWord == null) {
				this.pagingHtml.append("<a href=" + pageUrl + "?pageNum=1" + addKey + " style='text-decoration: none;'>");

			} else {
				this.pagingHtml.append("<a href=" + pageUrl + "?keyField=" + keyField + "&keyWord=" + keyWord
						+ "&pageNum=1" + addKey + " style='text-decoration: none;'>");
			}
		...
		if (currentPage > blockPage) {
			if (keyWord == null) {
				...
				this.pagingHtml.append("<a href=" + pageUrl + "?keyField=" + keyField + "&keyWord=" + keyWord
						+ "&pageNum=" + (startPage - 1) + addKey + " style='text-decoration: none;'>");
			}
			this.pagingHtml.append("<font size='2'><</font>");
			this.pagingHtml.append("</a>");
		}
		...
		if (totalPage - startPage >= blockPage) {
			if (keyWord == null) {
				...
				this.pagingHtml.append("<a href=" + pageUrl + "?keyField=" + keyField + "&keyWord=" + keyWord
						+ "&pageNum=" + (endPage + 1) + addKey + " style='text-decoration: none;'>");
			}
			this.pagingHtml.append("<font size='2'>></font>");
			this.pagingHtml.append("</a>");
		}
		...
		if (totalPage > endPage) {
			if (keyWord == null) {
				...
				this.pagingHtml.append("<a href=" + pageUrl + "?keyField=" + keyField + "&keyWord=" + keyWord
						+ "&pageNum=" + totalPage + addKey + " style='text-decoration: none;'>");
				this.pagingHtml.append("<font size='2'> >></font>");
				this.pagingHtml.append("</a>");
			}
		}
